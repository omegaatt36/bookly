...
type Querier interface {
	...
	ListBudgetsByUserID(ctx context.Context, userID int32) ([]Budget, error)
	ListLedgersByUserIDDateRangeCategory(ctx context.Context, arg ListLedgersByUserIDDateRangeCategoryParams) ([]ListLedgersByUserIDDateRangeCategoryRow, error)
